                    ...
                    <div className="blog-info">
                        ...
                        <div className="title-meta">
                            ...
                            <div className="post-meta">
                                <ul>
                                    <li>Posted By: <Link to={blogpost.authorLink}>{blogpost.authorName}</Link> <Icofont icon="icofont-funky-man" /></li>
                                    <li>Comments: <Link to={blogpost.CommentsLink}>{blogpost.TotalComments}</Link> <Icofont icon="icofont-speech-comments" /></li>
                                    <li>Tags: <Link to={blogpost.TagLink}>{blogpost.TagName}</Link> <Icofont icon="icofont-tags" /></li>
                                </ul>
                            </div>
                        </div>
                    </div>
